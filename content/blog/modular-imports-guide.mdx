...
*Check your bundle impact with `npx @next/bundle-analyzer` and see the difference modular imports make. Full documentation is available in the [import guide](/docs).*
