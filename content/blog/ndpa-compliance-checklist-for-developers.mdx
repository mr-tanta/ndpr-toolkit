...
## 1. [Consent](/ndpr-demos/consent) Collection (NDPA Section 25-26)
...
**Key rule:** Consent must be refreshed every 13 months. The toolkit handles this automatically. For a deeper dive, read [Consent Management Best Practices](/blog/consent-management-best-practices).

## 2. [Data Subject Rights](/ndpr-demos/dsr) (NDPA Sections 29-36)
...
## 3. [Breach Notification](/ndpr-demos/breach) (NDPA Section 40)
...
## 4. [Data Protection Impact Assessment](/ndpr-demos/dpia) (NDPA Section 38)
...
## 5. [Cross-Border Transfers](/ndpr-demos/cross-border) (NDPA Sections 41-45)
...
## 7. [Record of Processing Activities](/ndpr-demos/ropa)
...
For the full API reference, visit the [documentation](/docs) or explore the [interactive demos](/ndpr-demos).
