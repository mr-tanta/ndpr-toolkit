...
**1. Consent** — The data subject has given clear, informed consent for a specific purpose. This is the basis most developers will use for marketing, analytics, and non-essential processing.
...
*The NDPA Toolkit is open-source and available on [GitHub](https://github.com/mr-tanta/ndpr-toolkit). Contributions are welcome.*
