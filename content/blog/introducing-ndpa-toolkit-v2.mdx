...
This means a fintech app that only needs [consent management](/docs/components/consent-management) can import just that module, keeping the bundle lean. For more details on import strategies, see the [modular imports guide](/blog/modular-imports-guide).
...
*Install it today: `pnpm add @tantainnovative/ndpr-toolkit` — see the [npm package](https://www.npmjs.com/package/@tantainnovative/ndpr-toolkit) for details.*
