...
export function getComplianceScore(input: ComplianceInput): ComplianceReport {
  ...
  const regulatoryReferences: RegulatoryReference[] = [
    ...
    { section: 'Section 34', title: 'Data subject rights (access, rectification, erasure, restriction)' },
    { section: 'Section 35', title: 'Right to withdraw consent' },
    { section: 'Section 36', title: 'Right to object' },
    { section: 'Section 37', title: 'Rights related to automated decision-making' },
    { section: 'Section 38', title: 'Right to data portability' },
    { section: 'Section 40', title: 'Data breach notification' },
    { section: 'Section 41', title: 'Cross-border transfer mechanisms (SCCs / BCRs)' },
    { section: 'Section 42', title: 'Cross-border adequacy decisions' },
    { section: 'Section 43', title: 'Cross-border transfer derogations' },
  ];
