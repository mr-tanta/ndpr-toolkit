...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { title: 'NDPRProvider', href: '/docs/components/ndpr-provider', isNew: true },
      { title: 'NDPRThemeProvider', href: '/docs/components/ndpr-theme-provider', isNew: true },
      { title: 'NDPRDashboard', href: '/docs/components/ndpr-dashboard', isNew: true },
      { title: 'LegalNotice', href: '/docs/components/legal-notice', isNew: true },
      ...
      { title: 'AdaptivePolicyWizard', href: '/docs/components/adaptive-policy-wizard', isNew: true },
      { title: 'PolicyPage', href: '/docs/components/policy-page', isNew: true },
      { title: 'Hooks', href: '/docs/components/hooks' },
      { title: 'Lawful Basis Tracker', href: '/docs/components/lawful-basis-tracker', isNew: true },
      { title: 'Lawful Basis Tracker (Lite)', href: '/docs/components/lawful-basis-tracker-lite', isNew: true },
      { title: 'Cross-Border Transfers', href: '/docs/components/cross-border-transfers', isNew: true },
      { title: 'Cross-Border Transfers (Lite)', href: '/docs/components/cross-border-transfer-manager-lite', isNew: true },
      { title: 'ROPA', href: '/docs/components/ropa', isNew: true },
      { title: 'ROPA (Lite)', href: '/docs/components/ropa-manager-lite', isNew: true },
    ],
  },
  {
    ...
    children: [
      ...
      { title: 'Migrating 4.1 → 5.0', href: '/docs/guides/migrating-4-1-to-5-0', isNew: true },
      { title: 'Migrating 5.7 → 6.0', href: '/docs/guides/migrating-5-7-to-6-0', isNew: true },
      ...
      { title: 'Styling & Customization', href: '/docs/guides/styling-customization' },
      { title: 'Storage Adapters', href: '/docs/guides/adapters' },
