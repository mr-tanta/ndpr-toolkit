...
export default function LawfulBasisDemoPage() {
  ...
  if (!isClient) {
    return (
      <DemoLayout
        ...
        description="Document and manage the legal grounds for every data processing activity. Ensure every operation has a valid lawful basis under the NDPA."
        ndpaSection="Section 25"
        code={`import { LawfulBasisTracker } from '@tantainnovative/ndpr-toolkit/lawful-basis';`}
      >
  ...
  return (
    <DemoLayout
      title="Lawful Basis Tracker"
      description="Document and manage the legal grounds for every data processing activity. Ensure every operation has a valid lawful basis under the Nigeria Data Protection Act."
      ndpaSection="Section 25"
      code={`import { LawfulBasisTracker } from '@tantainnovative/ndpr-toolkit/lawful-basis';`}
    >
      <div
      ...
      >
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-lg px-4 py-2 text-sm">
            ...
            <span className="text-gray-500 dark:text-gray-400">Bases Used</span>
          </div>
          <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-800 rounded-lg px-4 py-2 text-sm">
