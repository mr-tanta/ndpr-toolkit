  ...
  return (
    ...
    >
      <section id="introduction" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Overview of ndpr-recipes</h2>
        <p className="mb-4">
          <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm">@tantainnovative/ndpr-recipes</code> is an optional companion package that provides pre-built backend
        ...
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`pnpm add @tantainnovative/ndpr-recipes
# or
bun add @tantainnovative/ndpr-recipes`}</code></pre>
          </div>
        </div>

        <p className="mb-4">The package has peer dependencies on the main toolkit:</p>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`{
  "peerDependencies": {
    ...
    "@prisma/client": ">=5.0.0"    // optional — only if you use Prisma adapters
      ...
      <section id="prisma-setup" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Setting Up Prisma</h2>
        <p className="mb-4">
          The recipes package ships a Prisma schema fragment with tables for consent records, DSR submissions, and
          breach reports. Copy it into your project&apos;s <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm">prisma/schema.prisma</code> and run a migration.
        </p>

        <h3 className="text-xl font-bold mb-3">Step 1: Copy the schema fragment</h3>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`// prisma/schema.prisma  (append to your existing schema)
...
model BreachReport {
  ...
  updatedAt       DateTime @updatedAt
        ...
        <h3 className="text-xl font-bold mb-3">Step 2: Run the migration</h3>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`pnpx prisma migrate dev --name add-ndpr-tables`}</code></pre>
          </div>
        </div>
      </section>

      <section id="prisma-adapters" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Using Prisma Adapters with Toolkit Hooks</h2>
        <p className="mb-4">
          After migrations are applied, import the Prisma adapter factories from <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm">ndpr-recipes</code> and pass
          them to your toolkit hooks exactly as you would with the built-in adapters.
        </p>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`// src/lib/ndpr-adapters.ts
...
export const breachAdapter = createPrismaBreachAdapter(prisma);`}</code></pre>
        ...
        <p className="mb-4">Use the adapters in your components:</p>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
  ...
  return (
    ...
    >
      ...
      <section id="nextjs-routes" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Next.js API Routes</h2>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold mb-3">Consent API</h3>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`// src/app/api/consent/route.ts
...
export { GET, POST };`}</code></pre>
        ...
        <h3 className="text-xl font-bold mb-3">DSR API</h3>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`// src/app/api/dsr/route.ts
...
export { GET, POST };`}</code></pre>
        ...
        <h3 className="text-xl font-bold mb-3">Breach notification API</h3>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`// src/app/api/breach/route.ts
...
export { GET, POST, PATCH };`}</code></pre>
        ...
        <p className="mb-4">
          The <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm">apiAdapter</code> from the main toolkit will point to these endpoints automatically
          when you configure it with the matching <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm">baseUrl</code>:
        </p>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`import { apiAdapter } from '@tantainnovative/ndpr-toolkit';
...
const dsrAdapter     = apiAdapter({ baseUrl: '/api/dsr' });`}</code></pre>
      ...
      <section id="express-routes" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Express Routes</h2>
        <p className="mb-4">
          For non-Next.js Node.js backends, use the Express router factory:
        </p>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`// src/routes/ndpr.ts
...
// PATCH /api/ndpr/breach/:id`}</code></pre>
      ...
      <section id="cli-scaffolder" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">The create-ndpr CLI Scaffolder</h2>
        <p className="mb-4">
        ...
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`npx create-ndpr@latest`}</code></pre>
          </div>
        </div>
        <p className="mb-4">
...
✓ Scaffold complete!
  ...
  → __tests__/dsr.test.ts`}</code></pre>
        ...
        <h3 className="text-xl font-bold mb-3">Adding modules to an existing project</h3>
        <p className="mb-4">
          Use the <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm">--add</code> flag to scaffold just the files you need into an existing codebase:
        </p>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`npx create-ndpr@latest --add dsr --add breach --framework nextjs`}</code></pre>
          </div>
        </div>
      </section>
      ...
      <section id="environment-variables" className="mb-8">
        ...
        <p className="mb-4">
          The scaffolder generates a <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm">.env.example</code> file. Copy it to <code className="bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 rounded text-sm">.env.local</code> and fill in your values:
        </p>
        <div className="bg-gray-100 dark:bg-gray-800 p-4 rounded-md mb-4">
          <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
            <pre><code>{`# Database
