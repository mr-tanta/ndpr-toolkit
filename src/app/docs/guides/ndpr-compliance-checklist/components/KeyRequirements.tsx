  ...
  return (
    <section id="key-requirements" className="mb-8">
      ...
      <div className="space-y-6">
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Lawful Processing</h3>
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Consent</h3>
          <p className="text-muted-foreground">
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Data Subject Rights</h3>
          <p className="text-muted-foreground">
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Data Protection Impact Assessment</h3>
          <p className="text-muted-foreground">
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Data Protection Officer</h3>
          <p className="text-muted-foreground">
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Breach Notification</h3>
          <p className="text-muted-foreground">
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Privacy Policy</h3>
          <p className="text-muted-foreground">
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">International Transfers</h3>
          <p className="text-muted-foreground">
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Data Security</h3>
          <p className="text-muted-foreground">
        ...
        <div className="bg-card border-l-4 border-primary border border-border rounded-xl p-6">
          <h3 className="text-xl font-bold mb-2 text-foreground">Record Keeping</h3>
          <p className="text-muted-foreground">
