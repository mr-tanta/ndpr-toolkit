  ...
  return (
    ...
    >
      <section id="introduction" className="mb-8">
        <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">What Are Presets?</h2>
      ...
      <section id="quickstart" className="mb-8">
        <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">3-File Quickstart</h2>
        <p className="mb-4 text-foreground">
          The fastest way to achieve NDPA 2023 compliance is to add three files to your Next.js project.
          The example below uses the <code className="bg-card border border-border px-1.5 py-0.5 rounded text-sm">ndprPreset</code> for a minimal setup — consent banner, a privacy
          policy page, and a data subject request (DSR) form.
        </p>

        <h3 className="text-xl font-bold text-foreground mb-3">File 1: Root layout — add NDPRProvider</h3>
  ...
  return (
    <html lang="en">
      <body>
        ...
        <h3 className="text-xl font-bold text-foreground mb-3">File 2: Privacy policy page</h3>
        <div className="bg-card border border-border rounded-xl p-4 overflow-x-auto mb-6">
          <pre className="text-foreground"><code>{`// src/app/privacy-policy/page.tsx
  ...
  return (
    <main className="max-w-3xl mx-auto py-12 px-4">
      ...
      />
        ...
        <h3 className="text-xl font-bold text-foreground mb-3">File 3: DSR (data subject request) page</h3>
        <div className="bg-card border border-border rounded-xl p-4 overflow-x-auto mb-6">
          <pre className="text-foreground"><code>{`// src/app/data-rights/page.tsx
  ...
  return (
    <main className="max-w-2xl mx-auto py-12 px-4">
      ...
      <section id="all-presets" className="mb-8">
        <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">All 8 Presets</h2>

        <div className="overflow-x-auto mb-6">
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-muted">
                <th className="border border-border px-4 py-2 text-left font-semibold text-foreground">Preset</th>
                <th className="border border-border px-4 py-2 text-left font-semibold text-foreground">Default Behaviour</th>
                <th className="border border-border px-4 py-2 text-left font-semibold text-foreground">Required Props</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-border">
                <td className="border border-border px-4 py-2 font-mono text-foreground">ndprPreset</td>
                <td className="border border-border px-4 py-2 text-foreground">
                  Consent banner (bottom), localStorage adapter, 3 default categories
                </td>
                <td className="border border-border px-4 py-2 font-mono text-xs text-foreground">—</td>
              </tr>
              <tr className="border-b border-border bg-muted/30">
                <td className="border border-border px-4 py-2 font-mono text-foreground">ConsentPreset</td>
                <td className="border border-border px-4 py-2 text-foreground">
              ...
              <tr className="border-b border-border">
                <td className="border border-border px-4 py-2 font-mono text-foreground">DSRPreset</td>
                <td className="border border-border px-4 py-2 text-foreground">
                  Full DSR form with all 6 NDPA request types, success confirmation, email notification hook
                </td>
                <td className="border border-border px-4 py-2 font-mono text-xs text-foreground">organizationName, onSubmit</td>
              </tr>
              <tr className="border-b border-border bg-muted/30">
                <td className="border border-border px-4 py-2 font-mono text-foreground">DPIAPreset</td>
                <td className="border border-border px-4 py-2 text-foreground">
                  Multi-section DPIA questionnaire with risk matrix, PDF export
                </td>
                <td className="border border-border px-4 py-2 font-mono text-xs text-foreground">projectName</td>
              </tr>
              <tr className="border-b border-border">
                <td className="border border-border px-4 py-2 font-mono text-foreground">BreachPreset</td>
                <td className="border border-border px-4 py-2 text-foreground">
                  Breach notification form, 72-hour timer, NDPC reporting checklist
                </td>
                <td className="border border-border px-4 py-2 font-mono text-xs text-foreground">onSubmit</td>
              </tr>
              <tr className="border-b border-border bg-muted/30">
                <td className="border border-border px-4 py-2 font-mono text-foreground">PrivacyPolicyPreset</td>
                <td className="border border-border px-4 py-2 text-foreground">
                  Full NDPA-compliant privacy policy with all required clauses, auto-date
                </td>
                <td className="border border-border px-4 py-2 font-mono text-xs text-foreground">organization, email</td>
              </tr>
              <tr className="border-b border-border">
                <td className="border border-border px-4 py-2 font-mono text-foreground">LawfulBasisPreset</td>
                <td className="border border-border px-4 py-2 text-foreground">
              ...
              <tr className="bg-muted/30">
                <td className="border border-border px-4 py-2 font-mono text-foreground">ROPAPreset</td>
                <td className="border border-border px-4 py-2 text-foreground">
                  Record of Processing Activities register, CSV/PDF export, Article 44 references
                </td>
                <td className="border border-border px-4 py-2 font-mono text-xs text-foreground">organizationName</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section id="overriding" className="mb-8">
        <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">Overriding Preset Defaults</h2>
        <p className="mb-4 text-foreground">
        ...
        <h3 className="text-xl font-bold text-foreground mb-3">Custom categories</h3>
        <div className="bg-card border border-border rounded-xl p-4 overflow-x-auto mb-4">
          <pre className="text-foreground"><code>{`import { ConsentPreset } from '@tantainnovative/ndpr-toolkit';
...
<ConsentPreset categories={myCategories} />`}</code></pre>
        ...
        <h3 className="text-xl font-bold text-foreground mb-3">Custom position and styling</h3>
        <div className="bg-card border border-border rounded-xl p-4 overflow-x-auto mb-4">
          <pre className="text-foreground"><code>{`<ConsentPreset
...
/>`}</code></pre>
        ...
        <h3 className="text-xl font-bold text-foreground mb-3">Custom copy</h3>
        <div className="bg-card border border-border rounded-xl p-4 overflow-x-auto mb-4">
          <pre className="text-foreground"><code>{`<ConsentPreset
...
/>`}</code></pre>
      ...
      <section id="with-provider" className="mb-8">
        <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">Using Presets with NDPRProvider</h2>
        <p className="mb-4 text-foreground">
          <code className="bg-card border border-border px-1.5 py-0.5 rounded text-sm">NDPRProvider</code> is an optional root provider that forwards a preset — and optionally an adapter — to all
  ...
  return (
    <html lang="en">
      ...
      <section id="with-adapters" className="mb-8">
        <h2 className="text-2xl font-bold text-foreground mt-12 mb-4">Using Presets with Custom Adapters</h2>
        <p className="mb-4 text-foreground">
          All presets default to <code className="bg-card border border-border px-1.5 py-0.5 rounded text-sm">localStorageAdapter</code>. Pass a different adapter via the{' '}
          <code className="bg-card border border-border px-1.5 py-0.5 rounded text-sm">adapter</code> prop (or via <code className="bg-card border border-border px-1.5 py-0.5 rounded text-sm">NDPRProvider</code>) to switch to API-backed storage:
        </p>
        <div className="bg-card border border-border rounded-xl p-4 overflow-x-auto mb-4">
...
export function App() {
  return <ConsentPreset adapter={adapter} />;
        ...
        <p className="text-sm text-muted-foreground">
          See the <Link href="/docs/guides/adapters" className="text-blue-600 dark:text-blue-400 hover:underline">Storage Adapters guide</Link> for the full adapter API and the <code className="bg-card border border-border px-1 rounded">composeAdapters</code> pattern.
        </p>
      </section>
