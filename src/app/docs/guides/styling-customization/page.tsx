  ...
  return (
    ...
    >
      ...
      <section id="introduction" className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border rounded-lg p-4 bg-white dark:bg-gray-800">
            <h4 className="font-semibold mb-1">1. Default</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Use the built-in Tailwind styles as-is. Zero configuration required.
            </p>
          </div>
          <div className="border rounded-lg p-4 bg-white dark:bg-gray-800">
            <h4 className="font-semibold mb-1">2. classNames Overrides</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="border rounded-lg p-4 bg-white dark:bg-gray-800">
            <h4 className="font-semibold mb-1">3. Unstyled</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <section id="default-mode" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Mode 1 &mdash; Default Styles</h2>
        <p className="mb-4">
  ...
  return (
    ...
    />
      ...
      <section id="classnames-overrides" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Mode 2 &mdash; classNames Overrides</h2>
        <p className="mb-4">
          Every component exposes a <code className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-sm">classNames</code> prop &mdash; an object keyed by semantic section name.
...
/>`}</code></pre>
        ...
        <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
          In the example above, only <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">root</code>,{' '}
          <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">acceptButton</code>, and{' '}
          <code className="bg-gray-100 dark:bg-gray-700 px-1 rounded">rejectButton</code> are
      ...
      <section id="unstyled-mode" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Mode 3 &mdash; Unstyled</h2>
        <p className="mb-4">
          Set <code className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-sm">unstyled=&#123;true&#125;</code> to
...
/>`}</code></pre>
      ...
      <section id="resolve-class" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">How It Works &mdash; The resolveClass Utility</h2>
        <p className="mb-4">
          Under the hood, every component calls a small helper function called{' '}
          <code className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-sm">resolveClass</code>{' '}
          for each rendered element. The logic is straightforward:
        </p>
        <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto">
          <pre><code>{`export function resolveClass(
  defaultClass: string,
  override?: string,
  unstyled?: boolean
): string {
  ...
  return defaultClass;
        ...
        <div className="mt-4 space-y-2 text-sm">
          <div className="flex items-start gap-2">
            <span className="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded shrink-0">unstyled + override</span>
            <span className="text-gray-600 dark:text-gray-400">&rarr; Uses only the override class</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded shrink-0">unstyled, no override</span>
            <span className="text-gray-600 dark:text-gray-400">&rarr; Returns an empty string (no styling at all)</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded shrink-0">override only</span>
            <span className="text-gray-600 dark:text-gray-400">&rarr; Replaces the default with the override</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="font-mono bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded shrink-0">neither</span>
            <span className="text-gray-600 dark:text-gray-400">&rarr; Uses the built-in default class</span>
          </div>
        </div>
      </section>
      ...
      <section id="bootstrap-example" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Example: Bootstrap</h2>
        <p className="mb-4">
...
/>`}</code></pre>
      ...
      <section id="css-modules-example" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Example: CSS Modules</h2>
        <p className="mb-4">
        ...
        <div className="bg-gray-800 text-gray-200 p-4 rounded-md overflow-x-auto mb-4">
          <pre><code>{`/* consent-banner.module.css */
.root {
  position: fixed;
  bottom: 0;
  left: 0;
...
/>`}</code></pre>
      ...
      <section id="vanilla-css-example" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Example: Vanilla CSS</h2>
        <p className="mb-4">
...
/>`}</code></pre>
      ...
      <section id="classnames-reference" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">classNames Reference</h2>
        <p className="mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-2">Start with Defaults</h3>
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-2">Override, Don&apos;t Fight</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-2">Use Unstyled for Full Control</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-2">Keep Accessibility in Mind</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-2">Centralise Overrides</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-bold text-lg mb-2">Test in Both Modes</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
      ...
      <section id="shared-theme" className="mb-8">
        <h2 className="text-2xl font-bold mb-4">Advanced: Shared Theme Object</h2>
        <p className="mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card>
            <CardContent className="p-4">
              <h3 className="font-medium text-gray-900 dark:text-white mb-2">Component Documentation</h3>
          ...
          <Card>
            <CardContent className="p-4">
              <h3 className="font-medium text-gray-900 dark:text-white mb-2">GitHub Source</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm mb-3">
