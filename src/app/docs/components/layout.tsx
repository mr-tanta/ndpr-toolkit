...
export const metadata: Metadata = {
  ...
  description:
    'API reference for every NDPA Toolkit React component: cookie consent banner, DSR portal, DPIA questionnaire, 72-hour breach notification, RoPA, lawful-basis tracker, privacy-policy generator. NDPA 2023 compliant.',
  keywords:
  ...
  openGraph: {
    title: 'Nigeria NDPA Components — React API Reference',
    description:
      'Every NDPA Toolkit component: cookie consent, DSR portal, DPIA, 72-hour breach notification, RoPA, privacy-policy generator. Built for Nigeria NDPA 2023.',
    ...
    images: [
      {
        ...
        width: 1280,
        height: 800,
        alt: 'NDPA Toolkit — Nigeria NDPA Components Reference',
      },
    ],
    locale: 'en_NG',
    type: 'website',
